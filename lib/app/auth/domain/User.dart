...
class User extends Model {
  ...
  const User._internal(
      ...
      : _name = name,
        ...
        _active = active,
        _userName = userName,
        _subscribeStart = subscribeStart,
        _subscribeEnd = subscribeEnd,
        _email = email,
        _owner = owner,
  ...
  Map<String, dynamic> toJson() => {
        ...
        'active': _active,
        'userName': _userName,
        'subscribeStart': _subscribeStart,
        'subscribeEnd': _subscribeEnd,
        'email': _email,
        'owner': _owner,
  ...
  static final QueryField SUBSCRIBESTART =
      QueryField(fieldName: "subscribeStart");
